...
function crf_show_extra_profile_fields( $user ) {
	?>
	<h3><?php esc_html_e( 'Wallet Information', 'crf' ); ?></h3>

	<table class="form-table">
		<tr>
			<th><label for="year_of_birth"><?php esc_html_e( 'Wallet Adress', 'crf' ); ?></label></th>
			<td><?php echo esc_html( get_the_author_meta( 'wallet_address', $user->ID ) ); ?></td>
		</tr>
	</table>
	<?php
}
