...
class WC_Form_Handler {
	...
	public static function save_account_details() {
		...
		$account_wallet_address = ! empty( $_POST['account_wallet_address'] ) ? wc_clean( $_POST['account_wallet_address'] ) : '';
		...
		$user->wallet_address = $account_wallet_address;
		
		update_user_meta( $user_id, 'wallet_address', sanitize_text_field($account_wallet_address) ); //Wallet Address
		...
		$required_fields = apply_filters( 'woocommerce_save_account_details_required_fields', array(
			...
			'account_wallet_address'  => __( 'Wallet Address', 'woocommerce' ),
