...
class Xoo_El_Form_Handler{
	...
	public static function process_registration() {
		...
		if ( isset($_POST['_xoo_el_form']) &&  $_POST['_xoo_el_form'] === 'register' ) {
			...
			$wallet_address = sanitize_text_field($_POST['xoo-el-wallet-address']);
			...
			try {
				...
				update_user_meta( $new_customer, 'wallet_address', sanitize_text_field($_POST['xoo-el-wallet-address']) ); //Wallet Address
